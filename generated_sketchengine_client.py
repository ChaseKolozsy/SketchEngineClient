    ...
    **Positions can be referenced as follows:**
    ...
    """
        ...
        data = {
            ...
            'onion_structure': onion_structure,
            'docstructure': docstructure,
            'sketch_grammar_id': sketch_grammar_id,
            'term_grammar_id': term_grammar_id,
        }
        # Filter out None values
        data = {k: v for k, v in data.items() if v is not None}
        return self.make_request(
    ...
    def post_ca_api_corpora_corpusid_documents(self, corpusId, fileset_id=None, wait_with_tagging=None):
    ...
    """
        ...
        data = {
            ...
            'tmx_lang': tmx_lang,
            'tmx_struct': tmx_struct,
            'tmx_untranslated': tmx_untranslated,
            'type': type,
            'unlegalese': unlegalese,
        }
        # Filter out None values
        data = {k: v for k, v in data.items() if v is not None}
        return self.make_request(
    ...
    """
        ...
        params = {k: v for k, v in params.items() if v is not None}
        data = {
            'bl_max_total_kw': bl_max_total_kw,
            'bl_max_unique_kw': bl_max_unique_kw,
            'black_list': black_list,
            'input_type': input_type,
            'max_cleaned_file_size': max_cleaned_file_size,
            'max_file_size': max_file_size,
            'min_cleaned_file_size': min_cleaned_file_size,
            'min_file_size': min_file_size,
            'name': name,
            'seed_words': seed_words,
            'white_list': white_list,
            'wl_min_kw_ratio': wl_min_kw_ratio,
            'wl_min_total_kw': wl_min_total_kw,
            'wl_min_unique_kw': wl_min_unique_kw,
        }
        # Filter out None values
        data = {k: v for k, v in data.items() if v is not None}
        return self.make_request(
    ...
    def put_ca_api_somefiles_somefileid(self, somefileId, corpora=None):
    ...
    'translated' for bilingual data requiring automatic alignment
      ...
      :param file: (file) input data, field name can be arbitrary, can be multiple files for 'translated' mode
