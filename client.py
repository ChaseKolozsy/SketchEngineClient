...
class SketchEngineClient:
    ...
    def get_search_corp_info(api_key, corpname=None, usesubcorp=None, subcorpora=None, gramrels=None, corpcheck=None, registry=None, struct_attr_stats=None, format=None):
    ...
    def get_search_wsketch(api_key, corpname=None, lemma=None, lpos=None, usesubcorp=None, minfreq=None, minscore=None, minsim=None, maxitems=None, clustercolls=None, expand_seppage=None, sort_ws_columns=None, structured=None, bim_corpname=None, bim_lemma=None, bim_lpos=None, format=None):
        """GET /search/wsketch
    Parameters:
      :param corpname: (query) Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
    ...
    def get_search_thes(api_key, corpname=None, lemma=None, lpos=None, usesubcorp=None, minthesscore=None, maxthesitems=None, clusteritems=None, minsim=None, format=None):
        """GET /search/thes
    Parameters:
      :param corpname: (query) Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
      :param lemma: (query) The base form of the word.
    ...
    def get_search_wsdiff(api_key, corpname=None, lemma=None, lpos=None, diff_by=None, lemma2=None, minfreq=None, maxcommon=None, separate_blocks=None, maxexclusive=None, wordform1=None, wordform2=None, subcorp1=None, subcorp2=None, format=None):
        """GET /search/wsdiff
    Parameters:
      :param corpname: (query) Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
      :param lemma: (query) The base form of the word.
    ...
    def get_search_fullref(api_key, corpname=None, pos=None):
        """GET /search/fullref
    Parameters:
      :param corpname: (query) Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
    ...
    def get_search_widectx(api_key, corpname=None, pos=None, hitlen=None, structs=None, detail_left_ctx=None, detail_right_ctx=None):
        """GET /search/widectx
    Parameters:
      :param corpname: (query) Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
      :param pos: (query) The position of the first token of KWIC in the corpus.
    ...
    **Positions can be referenced as follows:**
    ...
    def get_search_freqdist(api_key, corpname=None, wlattr=None, diaattr=None, sse=None, threshold=None, ctx=None, wordlist=None, json=None):
        """GET /search/freqdist
    Parameters:
      :param corpname: (query) Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
      :param wlattr: (query) Sets the corpus attribute you want to work with. Some corpora may have specific additional attributes.
    ...
    **Positions can be referenced as follows:**
    ...
    def get_search_collx(api_key, corpname=None, q=None, usesubcorp=None, cattr=None, csortfn=None, cbgrfns=None, cfromw=None, ctow=None, cminfreq=None, cminbgr=None, cmaxitems=None, json=None):
        """GET /search/collx
    Parameters:
      :param corpname: (query) Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
      :param q: (query) The CQL query. Regexes are supported for `lemma`, `phrase` and `word` types. The `iquery` supports simplified wildcards (see concordance_query[iquery]). If you decide to use the concordance_query in a json parameter, you do not have to use this parameter.
    ...
    def get_search_subcorp(api_key, corpname=None, subcname=None, create=None, delete=None, q=None, struct=None, json=None, format=None):
        """GET /search/subcorp
    Parameters:
      :param corpname: (query) Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
    ...
    def get_search_subcorpus_rename(api_key, corpname=None, subcorp_id=None, new_subcorp_name=None):
    ...
    def get_search_subcorp_info(api_key, corpname=None, subcname=None):
    ...
    def get_search_textypes_with_norms(api_key, corpname=None):
    ...
    def get_search_attr_vals(api_key, corpname=None, avattr=None, avpat=None, avfrom=None, avmaxitems=None, icase=None, format=None):
    ...
    def get_ca_api_corpora(api_key):
        """GET /ca/api/corpora
    Parameters:
    """
    ...
    def post_ca_api_corpora(api_key):
        """POST /ca/api/corpora
    Parameters:
    """
        url = f"https://api.sketchengine.eu/ca/api/corpora"
    ...
    def get_ca_api_corpora_corpusid(api_key, corpusId):
    ...
    def put_ca_api_corpora_corpusid(api_key, corpusId):
    ...
    def delete_ca_api_corpora_corpusid(api_key, corpusId):
    ...
    def post_ca_api_corpora_corpusid_can_be_compiled(api_key, corpusId):
    ...
    def post_ca_api_corpora_corpusid_get_progress(api_key, corpusId):
    ...
    def post_ca_api_corpora_corpusid_compile(api_key, corpusId):
    ...
    def get_ca_api_corpora_corpusid_logs_logname(api_key, corpusId, logName):
    ...
    def get_ca_api_corpora_corpusid_download(api_key, corpusId, format=None, file_structure=None, aligned=None):
    ...
    def post_ca_api_corpora_corpusid_cancel_job(api_key, corpusId):
    ...
    def post_ca_api_corpora_compile_aligned(api_key):
    ...
    def post_ca_api_corpora_align(api_key):
    ...
    def get_ca_api_corpora_corpusid_documents(api_key, corpusId, fileset_id=None):
    ...
    def post_ca_api_corpora_corpusid_documents(api_key, corpusId, corpusId_2, fileset_id=None, fileset_id_2=None, wait_with_tagging=None):
    ...
    def put_ca_api_corpora_corpusid_documents(api_key, corpusId, fileset_id=None):
    ...
    def get_ca_api_corpora_corpusid_documents_documentid(api_key, corpusId, documentId):
    ...
    def put_ca_api_corpora_corpusid_documents_documentid(api_key, corpusId, documentId):
    ...
    def delete_ca_api_corpora_corpusid_documents_documentid(api_key, corpusId, documentId):
    ...
    def post_ca_api_corpora_corpusid_documents_documentid_preview(api_key, corpusId, documentId):
    ...
    def get_ca_api_corpora_corpusid_documents_documentid_original(api_key, corpusId, documentId):
    ...
    def get_ca_api_corpora_corpusid_documents_documentid_plaintext(api_key, corpusId, documentId):
    ...
    def get_ca_api_corpora_corpusid_documents_documentid_vertical(api_key, corpusId, documentId):
    ...
    def post_ca_api_corpora_corpusid_documents_documentid_expand_archive(api_key, corpusId, documentId):
    ...
    def post_ca_api_corpora_corpusid_documents_documentid_cancel_job(api_key, corpusId, documentId):
    ...
    def post_ca_api_corpora_corpusid_documents_documentid_get_progress(api_key, corpusId, documentId):
    ...
    def get_ca_api_corpora_corpusid_filesets(api_key, corpusId, compile_when_finished=None):
    ...
    def post_ca_api_corpora_corpusid_filesets(api_key, corpusId, compile_when_finished=None):
    ...
    def get_ca_api_corpora_corpusid_filesets_filesetid(api_key, corpusId, filesetId):
    ...
    def delete_ca_api_corpora_corpusid_filesets_filesetid(api_key, corpusId, filesetId):
    ...
    def post_ca_api_corpora_corpusid_filesets_filesetid_cancel_job(api_key, corpusId, filesetId):
    ...
    def post_ca_api_corpora_corpusid_filesets_filesetid_get_progress(api_key, corpusId, filesetId):
    ...
    def get_ca_api_languages(api_key):
    ...
    def post_ca_api_somefiles(api_key):
    ...
    def get_ca_api_somefiles_somefileid(api_key, somefileId):
    ...
    def put_ca_api_somefiles_somefileid(api_key, somefileId):
    ...
    def get_ca_api_tagsets_templateid(api_key, templateId):
    ...
    def put_ca_api_tagsets_templateid(api_key, templateId):
    ...
    def delete_ca_api_tagsets_templateid(api_key, templateId):
    ...
    def post_ca_api_users_me_get_used_space(api_key):
    ...
    def post_ca_api_octerms_datasets(api_key):
    ...
    def get_ca_api_octerms_datasets_datasetid(api_key, datasetId):
